...
///
/// Generated by generateGMICuts() (sense always GreaterEq) or by a
/// user CutGenerator callback (any sense).  Consumed by the B&C loop
/// in solveMILP() via Model::addLPConstraint().
struct Cut {
    LinearExpr expr;
